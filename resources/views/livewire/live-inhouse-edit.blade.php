<x-modal wire:model="showInhouseEditForm" size="xxl">
    @isset($inhouse)
        <x-slot name="modalHeader">
            <div class="flex space-x-3 items-baseline">
                <h1 class="text-2xl font-semibold">Edit Inhouse</h1>
                <span>Remains: {{ round($remainingSessions * 60) }}mins</span>
                            ...
                            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-8">
                                ...
                                <div class="col-span-2 flex flex-col">
                                    ...
                                    <div class="flex-1 flex items-center mt-1 space-x-2">
                                        ...
                                        <button {{ $isAllowed ? '' : 'disabled' }} type="button"
        ...
        <x-slot name="modalLeftAction">
            ...
            <button type="button"
                    ...
                    class="inline-flex items-center rounded-md border border-transparent bg-white px-4 py-2 text-sm font-medium  shadow-sm focus:outline-none "
        ...
        <x-slot name="modalAction">
            <button type="button" wire:click="checkOut"
                    {{-- {{ $isDirty ? '' : 'disabled' }} --}}
                    class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md disabled:bg-gray-300 disabled:text-gray-400 enabled:text-white enabled:bg-primary enabled:hover:bg-blue-900 focus:outline-none">
                Check Out
            </button>
        </x-slot>
    @endisset
