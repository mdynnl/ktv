<div
     x-data="{
         show: @entangle('showInvoicePaymentFolioView'),
         message: '',
         success: false,
                    ...
                    <div class="bg-white shadow overflow-hidden sm:rounded-lg ">
                        ...
                        <div class="bg-primary flex items-center justify-between px-6 py-4 text-white">
                            <div class="flex space-x-4 items-baseline">
                                <h1 class="text-2xl font-semibold leading-none">Invoice | Payment</h1>
                            ...
                            <div class="mt-3">
                                <form wire:submit.prevent="updateTax">
                                    <div class="grid grid-cols-6 gap-x-3">
                                        ...
                                        @if ($checkout_payment_done)
                                            <x-form-disabled-comp class="col-span-1" wire:model.lazy="commercial_tax"
                                                                  label="Commercial Tax %"
                                                                  min="0" max="100" for="commercial_tax" />
                                        @else
                                            <x-form-number-input-comp class="col-span-1" wire:model.lazy="commercial_tax"
                                                                      label="Commercial Tax %"
                                                                      min="0" max="100" for="commercial_tax" />
                                        @endif
                                        ...
                                        <div class="col-span-1">
                                            ...
                                            <div class="mt-1">
                                                <div
                                                     class="bg-gray-100 block border border-gray-300 py-2 px-3 overflow-hidden rounded-md shadow-sm sm:text-sm text-gray-500 w-full">
                                                    <span>{{ $commercial_tax_amount }}</span>
                                                    {{-- @if (!empty($inhouse->commercial_tax))
                                                        <span>{{ ($payments->sum('amount') * $commercial_tax) / 100 }}</span>
                                                    @else
                                                        <span>0</span>
                                                    @endif --}}
                                                </div>
                                        ...
                                        @if ($checkout_payment_done)
                                            <x-form-disabled-comp class="col-span-1" wire:model.lazy="service_tax" label="Service Tax %"
                                                                  min="0" max="100" for="service_tax" />
                                        @else
                                            <x-form-number-input-comp class="col-span-1" wire:model.lazy="service_tax" label="Service Tax %"
                                                                      min="0" max="100" for="service_tax" />
                                        @endif
                                        ...
                                        <div class="col-span-1">
                                            ...
                                            <div class="mt-1">
                                                <div
                                                     class="bg-gray-100 block border border-gray-300 py-2 px-3 overflow-hidden rounded-md shadow-sm sm:text-sm text-gray-500 w-full">
                                                    <span>{{ $service_tax_amount }}</span>
                                                    {{-- @if (!empty($inhouse->service_tax))
                                                        <span>{{ ($payments->sum('amount') * $service_tax) / 100 }}</span>
                                                    @else
                                                        <span>0</span>
                                                    @endif --}}
                                                </div>
                            ...
                            <div class="flex justify-between items-center bg-gray-200">
                                ...
                                <div>
                                    ...
                                    <button type="button"
                                            ...
                                            {{ $isDirty ? '' : 'disabled' }}
                                            class="disabled:bg-gray-300 disabled:text-gray-500 enabled:bg-primary enabled:text-white enabled:hover:bg-blue-900 py-2 px-4 border rounded-md shadow-sm text-sm font-medium  focus:outline-none focus:ring-2 focus:ring-offset-2">
                                        Update
                                    </button>
                                </div>
                            </div>
