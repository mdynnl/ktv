<x-modal wire:model="showPurchaseDetailDeleteModal" size="md">
    @isset($purchaseDetail)
        <x-slot name="modalHeader">
            <h1 class="text-2xl font-semibold">
                Delete Purchase Item: {{ $purchaseDetail->item->item_name }}
            </h1>
        </x-slot>

        <div class="text-gray-700">
            <p class="text-base font-semibold">
                Are you sure you want to delete purchase item: {{ $purchaseDetail->item->item_name }}?
            </p>
