<x-modal wire:model="showServiceStaffDeleteModal" size="md">
    @isset($serviceStaff)
        <x-slot name="modalHeader">
            <h1 class="text-2xl font-semibold">
                Delete {{ $serviceStaff->name_on_nrc }}
            </h1>
        </x-slot>

        <div class="text-gray-700">
            <p class="text-base font-semibold">
                Are you sure you want to delete {{ $serviceStaff->name_on_nrc }} ({{ $serviceStaff->nick_name }})?
            </p>
