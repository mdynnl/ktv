<x-modal wire:model="showPurchaseDeleteModal" size="md">
    @isset($purchase)
        <x-slot name="modalHeader">
            <h1 class="text-2xl font-semibold">
                Delete Purchase with Invoice No: {{ $purchase->invoice_no }}
            </h1>
        </x-slot>

        <div class="text-gray-700">
            <p class="text-base font-semibold">
                Are you sure you want to delete purchase with Invoice No: {{ $purchase->invoice_no }}?
            </p>
