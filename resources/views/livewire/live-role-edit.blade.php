<div x-data="{ show: @entangle('showRoleEditForm') }"
    ...
    <div
        ...
        <div
            ...
            @isset($role)
                <div
                     class="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 max-w-5xl w-full">
                    <div class="bg-white shadow overflow-hidden sm:rounded-lg ">

                        <div class="bg-primary flex items-center justify-between px-6 py-4 text-white">
                            <div>
                                <h1 class="text-2xl font-semibold">Edit Role & Permissions</h1>
                            </div>
                        </div>
                                    ...
                                    <div class="space-y-6 sm:space-y-1">
                                        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                            ...
                                            <div class="col-span-6">
                                                ...
                                                <div class="bg-white grid grid-cols-4 gap-8 mt-3">
